...
import type { IntroTemplateCategory, IntroTemplateTag } from '@youpd/types';
import { cn } from '@youpd/ui/lib/utils';
import { Badge } from '@youpd/ui/components/ui/badge';

type LibraryFiltersProps = {
  categories: IntroTemplateCategory[];
  tags: IntroTemplateTag[];
...
function buildHref(input: { category?: string; tag?: string; q?: string }) {
  ...
  return query ? `/intro-templates?${query}` : '/intro-templates';
}

export function IntroLibraryFilters({
  categories,
  tags,
  activeCategory,
  activeTag,
